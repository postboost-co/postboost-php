...
/**
 * InitiateChunkedUploadRequest Class Doc Comment
 *
 * @category Class
 * @package  PostBoostClient
 * @author   OpenAPI Generator team
 ...
 */
class InitiateChunkedUploadRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'initiateChunkedUpload_request';
    ...
    */
    ...
    public function setFilename($filename)
    {
        ...
        if ((mb_strlen($filename) > 255)) {
            throw new \InvalidArgumentException('invalid length for $filename when calling InitiateChunkedUploadRequest., must be smaller than or equal to 255.');
        }

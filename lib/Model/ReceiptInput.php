...
/**
 * ReceiptInput Class Doc Comment
 *
 * @category Class
 * @package  PostBoostClient
 * @author   OpenAPI Generator team
 ...
 */
class ReceiptInput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ReceiptInput';
    ...
    protected static $setters = [
        'workspace_uuid' => 'setWorkspaceUuid',
    ...
    protected static $getters = [
        'workspace_uuid' => 'getWorkspaceUuid',
    ...
    {
        $this->setIfExists('workspace_uuid', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['workspace_uuid'] === null) {
            $invalidProperties[] = "'workspace_uuid' can't be null";
        }
     ...
     * @return string
     */
    public function getWorkspaceUuid()
    {
        return $this->container['workspace_uuid'];
    }

    /**
     * Sets workspace_uuid
     *
     * @param string $workspace_uuid workspace_uuid
     *
     * @return self
     */
    public function setWorkspaceUuid($workspace_uuid)
    {
        if (is_null($workspace_uuid)) {
            throw new \InvalidArgumentException('non-nullable workspace_uuid cannot be null');
        }
        $this->container['workspace_uuid'] = $workspace_uuid;

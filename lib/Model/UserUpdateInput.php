 ...
 */
class UserUpdateInput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UserUpdateInput';
    ...
    */
     ...
     * Sets password
     *
     * @param string|null $password Omit or set to null to keep the current password.
     *
     * @return self
     */
     ...
     *
     * @param string|null $password_confirmation password_confirmation
     *
     * @return self
     */

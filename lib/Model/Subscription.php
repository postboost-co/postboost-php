...
class Subscription implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'status' => '\PostBoostClient\Model\SubscriptionStatus',
        'recurring' => 'bool',
    ...
    protected static array $openAPINullables = [
        'name' => false,
        'platform_subscription_id' => false,
        'platform_plan_id' => false,
        'status' => false,
        'recurring' => false,
        'trial_ends_at' => false,
        'paused_from' => false,
    ...
    protected static $setters = [
        'name' => 'setName',
        'platform_subscription_id' => 'setPlatformSubscriptionId',
        'platform_plan_id' => 'setPlatformPlanId',
        'status' => 'setStatus',
        'recurring' => 'setRecurring',
        'trial_ends_at' => 'setTrialEndsAt',
        'paused_from' => 'setPausedFrom',
        'ends_at' => 'setEndsAt'
    ];
    ...
    protected static $getters = [
        'name' => 'getName',
        'platform_subscription_id' => 'getPlatformSubscriptionId',
        'platform_plan_id' => 'getPlatformPlanId',
        'status' => 'getStatus',
        'recurring' => 'getRecurring',
        'trial_ends_at' => 'getTrialEndsAt',
        'paused_from' => 'getPausedFrom',
        'ends_at' => 'getEndsAt'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('platform_subscription_id', $data ?? [], null);
        $this->setIfExists('platform_plan_id', $data ?? [], null);
        $this->setIfExists('status', $data ?? [], null);
        $this->setIfExists('recurring', $data ?? [], null);
        $this->setIfExists('trial_ends_at', $data ?? [], null);
        $this->setIfExists('paused_from', $data ?? [], null);
    ...
    */
    ...
    {
        return $this->container['platform_subscription_id'];
    }
     ...
     * @return self
     */
    public function setPlatformSubscriptionId($platform_subscription_id)
    {
        if (is_null($platform_subscription_id)) {
            throw new \InvalidArgumentException('non-nullable platform_subscription_id cannot be null');
        }
        $this->container['platform_subscription_id'] = $platform_subscription_id;
    ...
    {
        return $this->container['platform_plan_id'];
    }
     ...
     * @return self
     */
    public function setPlatformPlanId($platform_plan_id)
    {
        if (is_null($platform_plan_id)) {
            throw new \InvalidArgumentException('non-nullable platform_plan_id cannot be null');
        }
        $this->container['platform_plan_id'] = $platform_plan_id;
    ...
    public function setTrialEndsAt($trial_ends_at)
    {
        if (is_null($trial_ends_at)) {
            throw new \InvalidArgumentException('non-nullable trial_ends_at cannot be null');
        }
    ...
    {
        return $this->container['paused_from'];
    }

    /**
     * Sets paused_from
     *
     * @param \DateTime|null $paused_from paused_from
     *
     * @return self
     */
    public function setPausedFrom($paused_from)
    {
        if (is_null($paused_from)) {
            throw new \InvalidArgumentException('non-nullable paused_from cannot be null');
        }
        $this->container['paused_from'] = $paused_from;

...
/**
 * SchedulePostRequest Class Doc Comment
 *
 * @category Class
 * @package  PostBoostClient
 * @author   OpenAPI Generator team
 ...
 */
class SchedulePostRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'schedulePost_request';
    ...
    {
        $this->setIfExists('post_now', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['post_now'] === null) {
            $invalidProperties[] = "'post_now' can't be null";
        }
     ...
     * @return bool
     */
    public function getPostNow()
    {
        return $this->container['post_now'];
    }

    /**
     * Sets post_now
     *
     * @param bool $post_now post_now
     *
     * @return self
     */
    public function setPostNow($post_now)
    {
        if (is_null($post_now)) {
            throw new \InvalidArgumentException('non-nullable post_now cannot be null');
        }
        $this->container['post_now'] = $post_now;

 ...
 */
class PostVersion implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PostVersion';
    ...
    protected static $openAPITypes = [
        'account_id' => 'int',
        'is_original' => 'bool',
        'content' => '\PostBoostClient\Model\PostContent[]',
        'options' => 'object'
    ];
    ...
    */
     ...
     * Sets account_id
     *
     * @param int $account_id Use `0` for the original/default version.
     *
     * @return self
     */
     ...
     * Sets is_original
     *
     * @param bool $is_original Must be `true` for the first version.
     *
     * @return self
     */
     ...
     * Gets content
     *
     * @return \PostBoostClient\Model\PostContent[]
     */
     ...
     * Sets content
     *
     * @param \PostBoostClient\Model\PostContent[] $content content
     *
     * @return self
     */
     ...
     * Sets options
     *
     * @param object|null $options Platform-specific publishing options.
     *
     * @return self
     */

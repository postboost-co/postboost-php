...
/**
 * ImageEditInput Class Doc Comment
 *
 * @category Class
 * @package  PostBoostClient
 * @author   OpenAPI Generator team
 ...
 */
class ImageEditInput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ImageEditInput';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('mask_uuid', $data ?? [], null);
    ...
    */
     ...
     * Sets media_uuid
     *
     * @param string $media_uuid UUID of the source media item to edit
     *
     * @return self
     */
     ...
     * Sets prompt
     *
     * @param string $prompt Describe what to change in the image
     *
     * @return self
     */
    public function setPrompt($prompt)
    {
        ...
        if ((mb_strlen($prompt) > 4000)) {
            throw new \InvalidArgumentException('invalid length for $prompt when calling ImageEditInput., must be smaller than or equal to 4000.');
        }
    ...
    {
        return $this->container['mask_uuid'];
    }

    /**
     * Sets mask_uuid
     *
     * @param string|null $mask_uuid UUID of a mask image. Transparent areas will be edited.
     *
     * @return self
     */
    public function setMaskUuid($mask_uuid)
    {
        if (is_null($mask_uuid)) {
            throw new \InvalidArgumentException('non-nullable mask_uuid cannot be null');
        }
        $this->container['mask_uuid'] = $mask_uuid;
    ...
    public function setCount($count)
    {
        ...
        if (($count > 4)) {
            throw new \InvalidArgumentException('invalid value for $count when calling ImageEditInput., must be smaller than or equal to 4.');
        }
        if (($count < 1)) {
            throw new \InvalidArgumentException('invalid value for $count when calling ImageEditInput., must be bigger than or equal to 1.');
        }

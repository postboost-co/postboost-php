...
/**
 * DeletePostsBulkRequest Class Doc Comment
 *
 * @category Class
 * @package  PostBoostClient
 * @author   OpenAPI Generator team
 ...
 */
class DeletePostsBulkRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'deletePostsBulk_request';
    ...
    protected static $openAPITypes = [
        'posts' => 'string[]',
        'trash' => 'bool',
        'delete_mode' => '\PostBoostClient\Model\DeleteMode'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('trash', $data ?? [], false);
        $this->setIfExists('delete_mode', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets posts
     *
     * @param string[] $posts Array of post UUIDs to delete.
     *
     * @return self
     */
     ...
     * Sets trash
     *
     * @param bool|null $trash Move to trash instead of permanent delete.
     *
     * @return self
     */
     ...
     * Gets delete_mode
     *
     * @return \PostBoostClient\Model\DeleteMode|null
     */
    public function getDeleteMode()
    {
        return $this->container['delete_mode'];
    }

    /**
     * Sets delete_mode
     *
     * @param \PostBoostClient\Model\DeleteMode|null $delete_mode delete_mode
     *
     * @return self
     */
    public function setDeleteMode($delete_mode)
    {
        if (is_null($delete_mode)) {
            throw new \InvalidArgumentException('non-nullable delete_mode cannot be null');
        }
        $this->container['delete_mode'] = $delete_mode;

 ...
 */
class PostContent implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PostContent';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('video_thumbs', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets body
     *
     * @param string|null $body Post text/caption.
     *
     * @return self
     */
     ...
     * Sets media
     *
     * @param int[]|null $media Array of media IDs from the media library.
     *
     * @return self
     */
    ...
    {
        return $this->container['video_thumbs'];
    }

    /**
     * Sets video_thumbs
     *
     * @param object[]|null $video_thumbs video_thumbs
     *
     * @return self
     */
    public function setVideoThumbs($video_thumbs)
    {
        if (is_null($video_thumbs)) {
            throw new \InvalidArgumentException('non-nullable video_thumbs cannot be null');
        }
        $this->container['video_thumbs'] = $video_thumbs;

...
/**
 * InitiateRemoteUploadRequest Class Doc Comment
 *
 * @category Class
 * @package  PostBoostClient
 * @author   OpenAPI Generator team
 ...
 */
class InitiateRemoteUploadRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'initiateRemoteUpload_request';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['alt_text']) && (mb_strlen($this->container['alt_text']) > 255)) {
            $invalidProperties[] = "invalid value for 'alt_text', the character length must be smaller than or equal to 255.";
        }
    ...
    public function setAltText($alt_text)
    {
        ...
        if ((mb_strlen($alt_text) > 255)) {
            throw new \InvalidArgumentException('invalid length for $alt_text when calling InitiateRemoteUploadRequest., must be smaller than or equal to 255.');
        }

...
/**
 * GetRemoteUploadStatus200Response Class Doc Comment
 *
 * @category Class
 * @package  PostBoostClient
 * @author   OpenAPI Generator team
 ...
 */
class GetRemoteUploadStatus200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getRemoteUploadStatus_200_response';
    ...
    protected static $openAPITypes = [
        'status' => 'string',
        'media' => '\PostBoostClient\Model\Media'
    ];
    ...
    */
     ...
     * Sets media
     *
     * @param \PostBoostClient\Model\Media|null $media Present when status is complete.
     *
     * @return self
     */

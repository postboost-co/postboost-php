...
```json
{
  "repositories": [
    {
      "type": "vcs",
      "url": "https://github.com/postboost-co/postboost-php.git"
    }
  ],
  "require": {
    "postboost-co/postboost-php": "*@dev"
  }
}
```
...
- [InitiateChunkedUpload201Response](docs/Model/InitiateChunkedUpload201Response.md)
- [InitiateChunkedUploadRequest](docs/Model/InitiateChunkedUploadRequest.md)
- [InitiateRemoteUpload201Response](docs/Model/InitiateRemoteUpload201Response.md)
- [InitiateRemoteUpload201ResponseOneOf](docs/Model/InitiateRemoteUpload201ResponseOneOf.md)
...
- [UploadChunk201Response](docs/Model/UploadChunk201Response.md)
